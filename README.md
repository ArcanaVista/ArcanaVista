...
## 🧭 Навігація
1. [Про нас](#про-нас)
2. [Проєкт Telegram-Lab](#проєкт-telegram-lab)
3. [Наш Telegram-канал](#наш-telegram-канал)
...
[**Telegram-Lab**](https://github.com/ArcanaVista/Telegram-Lab) — Гайд зі створення та розвитку Telegram-каналу і чату. Тут ти знайдеш практичні рекомендації, шаблони й автоматизації для роботи з аудиторією.
---
[**Channel-Status**](https://github.com/ArcanaVista/Channel-Status) — Автоматичний моніторинг підписників Telegram-каналу із вивантаженням статусу у вигляді тексту та графіки у GitHub-репозиторій
---

---

## 📡 Наш Telegram-канал [**@ArcanaVista**](https://t.me/+OU1lpTQbSpA3OTdi)
